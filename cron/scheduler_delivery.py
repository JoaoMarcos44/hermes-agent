    ...
    try:
        ...
        if receipt is None and not deferred:
            ...
            if pending is not None:
                if not isinstance(pending, dict) or pending.get("content") != content or pending.get("home") != str(home):
        ...
        if receipt is not None:
            if not isinstance(receipt, dict) or receipt.get("message") != message:
                raise ValueError("delivery id already belongs to a different payload")
