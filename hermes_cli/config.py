...
def save_config(
    ...
    with _CONFIG_LOCK:
        ...
        _caller = sys._getframe(1)  # type: ignore[attr-defined]
        logger.info(
            ...
            _caller.f_code.co_name if _caller is not None and hasattr(_caller, "f_code") and _caller.f_code else "<module>",
        )
